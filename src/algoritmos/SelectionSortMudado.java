...
public class SelectionSort{
    ...
    public static void ordenarPorCasos(Vector<CovidData> vector, int typeSort){ //ordena por casos confirmados
    ...
    public static void ordenarPorNomeDasCidades(Vector<CovidData> vector, int typeSort){ ////ordena por cidades
    ...
    public static void ordenarPorObitos(Vector<CovidData> vector, int typeSort){ //ordena por obitos
        for (int i = 0; i < vector.size(); i++) {
            CovidData currentCovidDataToOrder = vector.findWithIndex(i);
            int lowestCovidDataIndex = i;
            int nextCovidDataOfSearch = i + 1;
